...
public class LocationUpdatesService extends Service {
    ...
    private static final String PACKAGE_NAME =
            "phannguyen.com.trackingsystem.services";
    ...
    public void onCreate() {
        ...
        mUserId = Utils.getLoginUser(this);
    }
    ...
    public void requestLocationUpdates() {
        ...
        //return if already request update location
    ...
    private Notification getNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_ID)
                .addAction(R.drawable.ic_exit, "Launch App",
                    ...
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful() && task.getResult() != null) {
                            ...
                            if(mUserId!=null && !mUserId.isEmpty())
                                ParseHelper.submitLocationToServer(mUserId,mLocation);
                        } else {
